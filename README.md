...
* **Kid-Friendly Layouts:** Smart rendering automatically stacks multi-digit arithmetic vertically, while formatting division cleanly as horizontal equations ($20 \div 5 =$ ___).
